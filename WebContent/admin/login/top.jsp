...
<script type="text/javascript">
	function exitSys() {
		...
		if (flag) {
			//window.top.open('', '/admin/login/louout.do', '');
			window.open("${pageContext.request.contextPath}/admin/login/louout.do", "_parent");
			window.top.close();
		}
			...
			<td height="30" valign="bottom"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td><font color="blue">${admin_user.username }</font></td>
						<td width="15%">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td width="16"
